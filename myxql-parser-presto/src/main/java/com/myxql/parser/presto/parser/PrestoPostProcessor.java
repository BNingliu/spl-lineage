...
import com.myxql.parser.presto.antlr4.SqlBaseBaseListener;
...
public class PrestoPostProcessor extends SqlBaseBaseListener {
    private final List<String> ruleNames;
    private final Consumer<ParsingWarning> warningConsumer;

    public PrestoPostProcessor(List<String> ruleNames, Consumer<ParsingWarning> warningConsumer) {
