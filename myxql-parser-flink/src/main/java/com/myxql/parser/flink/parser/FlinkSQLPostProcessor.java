...
import com.myxql.parser.flink.antlr4.FlinkSqlParserBaseListener;
...
public class FlinkSQLPostProcessor extends FlinkSqlParserBaseListener {
    ...
    public FlinkSQLPostProcessor(List<String> ruleNames, Consumer<ParsingWarning> warningConsumer) {
