...
public interface HplsqlListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link HplsqlParser#column_comment}.
	 * @param ctx the parse tree
	 */
	void enterColumn_comment(HplsqlParser.Column_commentContext ctx);
	/**
	 * Exit a parse tree produced by {@link HplsqlParser#column_comment}.
	 * @param ctx the parse tree
	 */
	void exitColumn_comment(HplsqlParser.Column_commentContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link HplsqlParser#partitionFieldList}.
	 * @param ctx the parse tree
	 */
	void enterPartitionFieldList(HplsqlParser.PartitionFieldListContext ctx);
	/**
	 * Exit a parse tree produced by {@link HplsqlParser#partitionFieldList}.
	 * @param ctx the parse tree
	 */
	void exitPartitionFieldList(HplsqlParser.PartitionFieldListContext ctx);
	/**
	 * Enter a parse tree produced by {@link HplsqlParser#partitionField}.
	 * @param ctx the parse tree
	 */
	void enterPartitionField(HplsqlParser.PartitionFieldContext ctx);
	/**
	 * Exit a parse tree produced by {@link HplsqlParser#partitionField}.
	 * @param ctx the parse tree
	 */
	void exitPartitionField(HplsqlParser.PartitionFieldContext ctx);
	/**
	 ...
	 * labeled alternative in {@link HplsqlParser#drop_stmt}.
	 * @param ctx the parse tree
	 */
	void enterDrop_table(HplsqlParser.Drop_tableContext ctx);
	/**
	 * Exit a parse tree produced by the {@code drop_table}
	 * labeled alternative in {@link HplsqlParser#drop_stmt}.
	 * @param ctx the parse tree
	 */
	void exitDrop_table(HplsqlParser.Drop_tableContext ctx);
	/**
	 * Enter a parse tree produced by the {@code drop_package}
	 * labeled alternative in {@link HplsqlParser#drop_stmt}.
	 * @param ctx the parse tree
	 */
	void enterDrop_package(HplsqlParser.Drop_packageContext ctx);
	/**
	 * Exit a parse tree produced by the {@code drop_package}
	 * labeled alternative in {@link HplsqlParser#drop_stmt}.
	 * @param ctx the parse tree
	 */
	void exitDrop_package(HplsqlParser.Drop_packageContext ctx);
	/**
	 * Enter a parse tree produced by the {@code drop_function}
	 * labeled alternative in {@link HplsqlParser#drop_stmt}.
	 * @param ctx the parse tree
	 */
	void enterDrop_function(HplsqlParser.Drop_functionContext ctx);
	/**
	 * Exit a parse tree produced by the {@code drop_function}
	 * labeled alternative in {@link HplsqlParser#drop_stmt}.
	 * @param ctx the parse tree
	 */
	void exitDrop_function(HplsqlParser.Drop_functionContext ctx);
	/**
	 * Enter a parse tree produced by the {@code drop_database}
	 * labeled alternative in {@link HplsqlParser#drop_stmt}.
	 * @param ctx the parse tree
	 */
	void enterDrop_database(HplsqlParser.Drop_databaseContext ctx);
	/**
	 * Exit a parse tree produced by the {@code drop_database}
	 * labeled alternative in {@link HplsqlParser#drop_stmt}.
	 * @param ctx the parse tree
	 */
	void exitDrop_database(HplsqlParser.Drop_databaseContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link HplsqlParser#partitionSpec}.
	 * @param ctx the parse tree
	 */
	void enterPartitionSpec(HplsqlParser.PartitionSpecContext ctx);
	/**
	 * Exit a parse tree produced by {@link HplsqlParser#partitionSpec}.
	 * @param ctx the parse tree
	 */
	void exitPartitionSpec(HplsqlParser.PartitionSpecContext ctx);
	/**
	 * Enter a parse tree produced by {@link HplsqlParser#partition_clause}.
	 * @param ctx the parse tree
	 */
	void enterPartition_clause(HplsqlParser.Partition_clauseContext ctx);
	/**
	 * Exit a parse tree produced by {@link HplsqlParser#partition_clause}.
	 * @param ctx the parse tree
	 */
	void exitPartition_clause(HplsqlParser.Partition_clauseContext ctx);
	/**
