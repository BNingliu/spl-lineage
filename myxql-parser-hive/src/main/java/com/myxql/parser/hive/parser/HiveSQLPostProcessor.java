...
import com.myxql.parser.hive.antlr4.HplsqlBaseListener;
...
public class HiveSQLPostProcessor extends HplsqlBaseListener {
    private final List<String> ruleNames;
    private final Consumer<ParsingWarning> warningConsumer;

    public HiveSQLPostProcessor(List<String> ruleNames, Consumer<ParsingWarning> warningConsumer) {
