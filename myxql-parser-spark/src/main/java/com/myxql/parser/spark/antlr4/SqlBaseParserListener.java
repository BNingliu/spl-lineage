...
public interface SqlBaseParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code collectSet}
	 * labeled alternative in {@link SqlBaseParser#primaryExpression}.
	 * @param ctx the parse tree
	 */
	void enterCollectSet(SqlBaseParser.CollectSetContext ctx);
	/**
	 * Exit a parse tree produced by the {@code collectSet}
	 * labeled alternative in {@link SqlBaseParser#primaryExpression}.
	 * @param ctx the parse tree
	 */
	void exitCollectSet(SqlBaseParser.CollectSetContext ctx);
	/**
