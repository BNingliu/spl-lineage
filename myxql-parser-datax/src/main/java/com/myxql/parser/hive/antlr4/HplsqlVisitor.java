...
public interface HplsqlVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link HplsqlParser#column_comment}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitColumn_comment(HplsqlParser.Column_commentContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link HplsqlParser#partitionFieldList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPartitionFieldList(HplsqlParser.PartitionFieldListContext ctx);
	/**
	 * Visit a parse tree produced by {@link HplsqlParser#partitionField}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPartitionField(HplsqlParser.PartitionFieldContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitDrop_table(HplsqlParser.Drop_tableContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitDrop_package(HplsqlParser.Drop_packageContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitDrop_function(HplsqlParser.Drop_functionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitDrop_database(HplsqlParser.Drop_databaseContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link HplsqlParser#partitionSpec}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPartitionSpec(HplsqlParser.PartitionSpecContext ctx);
	/**
	 * Visit a parse tree produced by {@link HplsqlParser#partition_clause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPartition_clause(HplsqlParser.Partition_clauseContext ctx);
	/**
