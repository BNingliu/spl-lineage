...
import com.myxql.parser.mysql.antlr4.MySqlParserBaseListener;
...
public class MySqlPostProcessor extends MySqlParserBaseListener {
    private final List<String> ruleNames;
    private final Consumer<ParsingWarning> warningConsumer;

    public MySqlPostProcessor(List<String> ruleNames, Consumer<ParsingWarning> warningConsumer) {
