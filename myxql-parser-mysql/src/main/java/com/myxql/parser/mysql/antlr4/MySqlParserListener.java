// Generated from com\myxql\parser\mysql\antlr4\MySqlParser.g4 by ANTLR 4.10.1
package com.myxql.parser.mysql.antlr4;
...
public interface MySqlParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MySqlParser#simpleSelect}.
	 * @param ctx the parse tree
	 */
	void enterSimpleSelect(MySqlParser.SimpleSelectContext ctx);
	/**
	 * Exit a parse tree produced by {@link MySqlParser#simpleSelect}.
	 * @param ctx the parse tree
	 */
	void exitSimpleSelect(MySqlParser.SimpleSelectContext ctx);
	/**
	 * Enter a parse tree produced by {@link MySqlParser#parenthesisSelect}.
	 * @param ctx the parse tree
	 */
	void enterParenthesisSelect(MySqlParser.ParenthesisSelectContext ctx);
	/**
	 * Exit a parse tree produced by {@link MySqlParser#parenthesisSelect}.
	 * @param ctx the parse tree
	 */
	void exitParenthesisSelect(MySqlParser.ParenthesisSelectContext ctx);
	/**
	 * Enter a parse tree produced by {@link MySqlParser#unionSelect}.
	 * @param ctx the parse tree
	 */
	void enterUnionSelect(MySqlParser.UnionSelectContext ctx);
	/**
	 * Exit a parse tree produced by {@link MySqlParser#unionSelect}.
	 * @param ctx the parse tree
	 */
	void exitUnionSelect(MySqlParser.UnionSelectContext ctx);
	/**
	 * Enter a parse tree produced by {@link MySqlParser#unionParenthesisSelect}.
	 * @param ctx the parse tree
	 */
	void enterUnionParenthesisSelect(MySqlParser.UnionParenthesisSelectContext ctx);
	/**
	 * Exit a parse tree produced by {@link MySqlParser#unionParenthesisSelect}.
	 * @param ctx the parse tree
	 */
	void exitUnionParenthesisSelect(MySqlParser.UnionParenthesisSelectContext ctx);
	/**
	 * Enter a parse tree produced by {@link MySqlParser#withLateralStatement}.
	 * @param ctx the parse tree
	 */
	void enterWithLateralStatement(MySqlParser.WithLateralStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link MySqlParser#withLateralStatement}.
	 * @param ctx the parse tree
	 */
