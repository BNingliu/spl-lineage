//package com.myxql.parser.postgresql;
//
...
// */
//public class PostgreSQLTableLineageParserTest {
//    private SqlParserService parserService = new MyPostgreSQLParser();
//    @Test
//    public void createTableAsSelectTest0() {
//        String sql = "create table t_key_event_file_student_100 as select a.* from datacompute1.datacompute.dc_job a left join datacompute1.datacompute.dc_job_scheduler b on a.id=b.job_id";
//
...
//        String sql = "CREATE DATABASE myxql";
//
//        StatementLineage statementLineage = parserService.parseSqlTableLineage(sql);
//        Optional<Statement> statement = statementLineage.getStatement();
//        statement.map(stmt -> {
